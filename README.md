...
[![Static Badge](https://img.shields.io/badge/chromium-1.2-blue?logo=GoogleChrome)](https://github.com/Wanja01YT/tiktok-scraper/releases/download/1.2/tiktok-scraper-1.2-chromium.zip)
...
## Downloads
- [Chromium (1.2)](https://github.com/Wanja01YT/tiktok-scraper/releases/download/1.1/tiktok-scraper-1.2-chromium.zip) <br> _Supported by any Chromium-based browser, such as Chrome, Edge, Opera_
