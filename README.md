...
## Downloads
- [Chromium (1.2)](https://github.com/Wanja01YT/tiktok-scraper/releases/download/1.2/tiktok-scraper-1.2-chromium.zip) <br> _Supported by any Chromium-based browser, such as Chrome, Edge, Opera_
